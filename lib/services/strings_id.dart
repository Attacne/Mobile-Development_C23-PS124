...
List<String> descAcneInfo_id = [
  "Jerawat blackhead (komedo hitam) adalah jenis jerawat non-radang yang terbentuk ketika pori-pori kulit tersumbat oleh sebum (minyak alami kulit), sel kulit mati, dan kotoran. Ketika pori-pori tersumbat, sebum yang terperangkap di dalamnya mengalami oksidasi dan menghasilkan warna hitam, mengakibatkan penampilan komedo hitam. \n\nBlackhead biasanya muncul di area kulit yang memiliki kelenjar minyak berlebih, seperti wajah, dada, dan punggung. Mereka memiliki tampilan permukaan yang terbuka dan terlihat seperti titik-titik hitam kecil di kulit.\n\nBlackhead sering disebabkan oleh kombinasi faktor-faktor seperti produksi minyak yang berlebihan, perubahan hormon, penumpukan sel kulit mati, penggunaan produk perawatan kulit yang tidak cocok, dan ketidakseimbangan bakteri pada kulit.Untuk mengobati jerawat blackhead, penting untuk menjaga kebersihan kulit secara teratur dengan membersihkannya secara lembut menggunakan pembersih wajah yang sesuai. Penggunaan eksfolian dan masker yang mengandung bahan seperti asam salisilat atau retinoid juga dapat membantu membersihkan pori-pori dan mencegah pembentukan blackhead baru. Jika jerawat blackhead Anda persisten atau parah, berkonsultasilah dengan dokter kulit untuk saran dan perawatan yang tepat.",
  ...
  "Jerawat papul adalah salah satu jenis jerawat yang sering muncul pada kulit. Jerawat papul ditandai dengan adanya benjolan kecil yang merah dan terangkat di permukaan kulit. Benjolan ini biasanya tidak terisi nanah dan tidak memiliki kepala putih seperti jerawat bernanah (pustules).\n\nJerawat papul terjadi ketika folikel rambut atau pori-pori kulit tersumbat oleh sebum (minyak alami kulit) dan sel kulit mati. Penyumbatan ini mengakibatkan peradangan pada kulit, yang menyebabkan munculnya benjolan merah pada area yang terkena.\n\nPada beberapa kasus, jerawat papul dapat terasa sedikit sakit atau gatal. Jika jerawat ini disentuh atau dipencet, bisa menyebabkan iritasi dan peradangan yang lebih parah, serta meningkatkan risiko infeksi.\n\nPengobatan untuk jerawat papul sering kali melibatkan perawatan kulit yang tepat, seperti membersihkan kulit secara teratur dengan pembersih yang lembut, menghindari penggunaan produk perawatan kulit yang mengandung bahan yang dapat menyumbat pori-pori, dan menggunakan produk perawatan kulit yang mengandung bahan seperti asam salisilat atau benzoyl peroxide yang dapat membantu membersihkan \n\npori-pori.Jika jerawat papul parah atau tidak merespon terhadap perawatan rumah, disarankan untuk berkonsultasi dengan dokter kulit atau ahli kecantikan yang dapat memberikan pengobatan tambahan, seperti krim atau obat yang mengandung retinoid, antibiotik topikal, atau terapi laser untuk mengurangi peradangan dan mengontrol jerawat.",
  "Jerawat pustula adalah jenis jerawat yang terbentuk ketika pori-pori kulit tersumbat oleh minyak, sel-sel kulit mati, dan bakteri Propionibacterium acnes. Jerawat ini ditandai dengan adanya benjolan merah yang terasa nyeri dan berisi nanah (pustula) di pusatnya.\n\nPustula terbentuk ketika pori-pori kulit yang tersumbat menjadi meradang dan terinfeksi. Proses ini terjadi ketika minyak alami (sebum) yang diproduksi oleh kelenjar minyak kulit terperangkap di dalam pori-pori, bersama dengan sel-sel kulit mati yang menumpuk. Bakteri Propionibacterium acnes yang ada di permukaan kulit juga dapat menyebabkan infeksi pada pori-pori yang tersumbat, menyebabkan pembengkakan dan peradangan.\n\nGejala umum dari jerawat pustula adalah benjolan merah yang terasa nyeri, dengan pus atau nanah yang terlihat di bagian tengahnya. Mereka cenderung lebih besar dan lebih meradang daripada jenis jerawat lainnya, seperti komedo atau jerawat biasa. Jerawat pustula juga bisa menyebabkan kulit terasa panas atau gatal di sekitar area yang terkena.\n\nPerawatan jerawat pustula umumnya melibatkan penggunaan produk perawatan kulit yang mengandung bahan aktif seperti benzoyl peroxide, asam salisilat, atau retinoid topikal. Jika jerawat pustula parah atau tidak merespons pengobatan topikal, dokter kulit mungkin meresepkan antibiotik oral atau obat anti-jerawat lainnya. Penting untuk tidak mencoba memencet atau mengeluarkan nanah dari jerawat pustula, karena ini dapat menyebabkan peradangan yang lebih parah atau infeksi lebih lanjut.\n\nPenting juga untuk menjaga kebersihan kulit dengan mencuci wajah secara teratur, menghindari penggunaan produk perawatan kulit yang berminyak, dan menghindari pemakaian kosmetik yang berpotensi menyumbat pori-pori. Jika jerawat pustula terus berlanjut atau mengganggu kehidupan sehari-hari Anda, disarankan untuk berkonsultasi dengan dokter kulit untuk evaluasi dan saran lebih lanjut.",
  "Jerawat Whitehead adalah salah satu jenis jerawat yang biasanya muncul dalam bentuk komedo putih kecil di kulit. Jerawat Whitehead, juga dikenal sebagai komedo tertutup, terjadi ketika pori-pori kulit tersumbat oleh sebum (minyak alami kulit), sel-sel kulit mati, dan bakteri, yang kemudian membentuk lepuh berwarna putih.\n\nPerbedaan antara jerawat Whitehead dan jerawat lainnya, seperti jerawat hitam atau jerawat merah yang terbuka, terletak pada sumbatan pori-pori. Pada jerawat Whitehead, pori-pori tertutup oleh lapisan kulit yang menyebabkan komedo tampak putih.\n\nJerawat Whitehead biasanya muncul pada daerah yang memiliki kelenjar minyak yang lebih aktif, seperti wajah, dada, dan punggung. Faktor-faktor yang dapat menyebabkan timbulnya jerawat Whitehead meliputi kelebihan produksi minyak kulit, perubahan hormon, penumpukan sel-sel kulit mati, dan infeksi bakteri pada pori-pori yang tersumbat.\n\nUntuk mengobati jerawat Whitehead, penting untuk menjaga kebersihan kulit dengan mencuci wajah secara teratur, menggunakan produk perawatan kulit yang sesuai, dan menghindari pemakaian kosmetik berminyak yang dapat menyumbat pori-pori. Penggunaan bahan aktif seperti asam salisilat atau benzoyl peroxide dapat membantu membersihkan pori-pori dan mengurangi pembentukan jerawat Whitehead. Jika jerawat Whitehead parah atau tidak merespon terhadap perawatan rumah, disarankan untuk berkonsultasi dengan dokter kulit untuk perawatan yang lebih lanjut.",
];
